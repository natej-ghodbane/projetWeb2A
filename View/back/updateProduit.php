    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                $list = $ProduitC->findProduit($_GET["id"]);
                ...
                if ($_SERVER["REQUEST_METHOD"] === "POST") {
                    if (
                        ...
                        if (empty($errors)) {
                            ...
                            $ProduitC->updateProduit($Produit1, $_GET["id"]);
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" id="nom" name="nom"oninput="validateInput('nom', /^[a-zA-Z]+$/)" value ='<?php echo $list ['nom']; ?>'><br>
                    <span id="nom_span"></span><br><br>
                    
                    <label for="description">Description:</label><br>
                    <textarea id="description" name="description" rows="4" cols="50" oninput="validateInput('description', /.*/g)"><?php echo $list ['description']; ?></textarea><br><br>
                    ...
                    <input type="number" id="prix" name="prix" step="0.01"oninput="validateInput('prix', /^[0-9]+(\.[0-9]{1,2})?$/)" value ='<?php echo $list ['prix']; ?>'><br><br>
                    <span id="prix_span"></span>
                    
                    <label for="stock">Stock:</label><br>
                    <input type="number" id="stock" name="stock"oninput="validateInput('stock', /^[0-9]+$/)"value ='<?php echo $list ['stock']; ?>'><br><br>
                    <span id="stock_span"></span>
                    
                    <label for="fournisseur">Fournisseur:</label><br>
                    <input type="text" id="fournisseur" name="fournisseur"oninput="validateInput('fournisseur', /^[a-zA-Z]+$/)" value ='<?php echo $list ['fournisseur']; ?>'><br><br>
                    <span id="fournisseur_span"></span>
                    
                    <label for="date_ajout">Date d'ajout:</label><br>
                    <input type="date" id="date_ajout" name="date_ajout" value ='<?php echo $list ['date_ajout']; ?>'><br><br>
