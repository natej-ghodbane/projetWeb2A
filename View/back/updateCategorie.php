        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <?php
                    ...
                    $list = $CategorieC->findCategorie($_GET["nom"]);
                    if (isset($_POST["nom_c"]) && isset($_POST["description"])) {
                        if (!empty($_POST["nom_c"]) && !empty($_POST["description"])) {
                            ...
                            $CategorieC = new CategorieC();
                            $CategorieC->updateCategorie($Categorie1, $_GET["nom"]);
                ...
                <h4>Ajouter Catégorie</h4>
                    ...
                    <form action="" method="POST">
                        ...
                        <input type="text" id="nom_c" name="nom_c" value ='<?php echo $list ['nom_c']; ?>' oninput="validateInput('nom_c', /^[a-zA-Z]+$/)"><br>
                        <span id="nom_c_span"></span>

                        <label for="description">Déscription:</label>
                        <textarea id="description" name="description" oninput="validateInput('description', /.*/g)"><?php echo $list ['description_c']; ?></textarea>
