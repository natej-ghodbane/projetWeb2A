                ...
                <table class="table">
                    ...
                    <?php foreach ($Produits as $product) { ?>
                        <tr>
                            ...
                            <td> <img src="<?= $relativePath ?>" alt="streamlab-image" style="width: 50px; padding:10px; height:50px "></td>
                            <td>
                                <a href="deleteProduit.php?id=<?= $product['id'] ?>" class="btn btn-primary">Delete</a>
                                <a href="updateProduit.php?id=<?= $product['id'] ?>" class="btn btn-primary">Update</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>

                <a href="ajouterProduit.php" style="background-color: #000000;" class="btn btn-primary"> Ajouter Produit <i class="fa fa-plus" aria-hidden="true"></i></a>
