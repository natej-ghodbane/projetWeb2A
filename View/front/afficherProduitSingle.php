...
<body>
   ...
   <?php
    ...
    <div class="product-details">
        ...
        <h5> <?php echo $list ['categorie']; ?> </h5>
        <h5> <?php echo $list ['prix']; ?> </h5>
        <h5> <?php echo $list ['stock']; ?> </h5>
        <h5> <?php echo $list ['date_ajout']; ?> </h5>
    </div>
  ...
  <style>
    ...
    text-align: center; /* Centre le contenu à l'intérieur de la div */
    }
